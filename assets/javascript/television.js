$(document).ready(() => {
  ...
  let teleBtn = $('#television-knowledge');
  ...
  function teleKnowledge() {


    const API = "https://opentdb.com/api.php?amount=20&category=14&difficulty=easy&type=multiple";
